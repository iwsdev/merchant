<div class="main-content" >
    ...
    <section id="page-title">
        <div class="row">
            <div class="col-sm-8">
            <h1 class="mainTitle">Create Ad</h1>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">
                              Add Ad Title <span class="symbol required"></span>
                            </label>
                     ...
                     <div class="form-group">
                            <label class="control-label">
                                Ad Description <span class="symbol required"></span>
                            </label>
                        ...
                        <div class="form-group connected-group">
                          <label class="control-label">
                             Upload Ad Image <span class="symbol required"></span>
                          </label>
                          <input type="file" id="adImage" name="adImage">
                          <img id="adImageShow" src="https://dummyimage.com/700x100/000/fff" alt="your image" style="height:100px;width:700px"/>
                    ...
                    <div class="form-group connected-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group" style="display: none;" id="stateField">
                            <label class="control-label" >
