    ...
    <head>
        ...
        <link href="<?php echo $this->request->webroot?>vendor/DataTables/css/DT_bootstrap.css" rel="stylesheet" media="screen">
        <link href="<?php echo $this->request->webroot?>vendor/sweetalert/sweet-alert.css" rel="stylesheet" media="screen">
        <link rel="stylesheet" href="<?php echo $this->request->webroot?>assets/css/datepicker.css"/>
